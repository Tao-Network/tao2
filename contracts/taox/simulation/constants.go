...
var (
	...
	// TRC21 Token
	MinTRC21Apply   = big.NewInt(0).Mul(big.NewInt(10), BaseTAO) // 10 TAO
	TRC21TokenCap   = big.NewInt(0).Mul(big.NewInt(1000000000000), BaseTAO)
	TRC21TokenFee   = big.NewInt(100)
	TaoXListingFee = big.NewInt(0).Mul(big.NewInt(1000), BaseTAO) // 1000 TAO
