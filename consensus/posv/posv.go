...
type TradingService interface {
	...
	ApplyOrder(coinbase common.Address, chain consensus.ChainContext, statedb *state.StateDB, taoXstatedb *tradingstate.TradingStateDB, orderBook common.Hash, order *tradingstate.OrderItem) ([]map[string]string, []*tradingstate.OrderItem, error)
...
func (c *Posv) YourTurn(chain consensus.ChainReader, parent *types.Header, signer common.Address) (int, int, int, bool, error) {
	...
	if common.IsTestnet {
		...
		masternodes = []common.Address{
			common.HexToAddress("0x8de698c1b792e3b8709579f2c4b3244faf020280"),
			common.HexToAddress("0x700899522c856bb2c5c728aa736dc0277d142852"),
			common.HexToAddress("0xb10d444940713bb7bed4c8c7f7aa7db307726173"),
		}
	}
