...
// LAbstractTAOXListingABI is the input ABI used to generate the binding from.
const LAbstractTAOXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractTAOXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractTAOXListingBin = `0x`

// DeployLAbstractTAOXListing deploys a new Ethereum contract, binding an instance of LAbstractTAOXListing to it.
func DeployLAbstractTAOXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractTAOXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTAOXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractTAOXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractTAOXListing{LAbstractTAOXListingCaller: LAbstractTAOXListingCaller{contract: contract}, LAbstractTAOXListingTransactor: LAbstractTAOXListingTransactor{contract: contract}, LAbstractTAOXListingFilterer: LAbstractTAOXListingFilterer{contract: contract}}, nil
}

// LAbstractTAOXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractTAOXListing struct {
	LAbstractTAOXListingCaller     // Read-only binding to the contract
	LAbstractTAOXListingTransactor // Write-only binding to the contract
	LAbstractTAOXListingFilterer   // Log filterer for contract events
}

// LAbstractTAOXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractTAOXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTAOXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractTAOXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTAOXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractTAOXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTAOXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractTAOXListingSession struct {
	Contract     *LAbstractTAOXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts          // Call options to use throughout this session
	TransactOpts bind.TransactOpts      // Transaction auth options to use throughout this session
}

// LAbstractTAOXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractTAOXListingCallerSession struct {
	Contract *LAbstractTAOXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                // Call options to use throughout this session
}

// LAbstractTAOXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractTAOXListingTransactorSession struct {
	Contract     *LAbstractTAOXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                // Transaction auth options to use throughout this session
}

// LAbstractTAOXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractTAOXListingRaw struct {
	Contract *LAbstractTAOXListing // Generic contract binding to access the raw methods on
}

// LAbstractTAOXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractTAOXListingCallerRaw struct {
	Contract *LAbstractTAOXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractTAOXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractTAOXListingTransactorRaw struct {
	Contract *LAbstractTAOXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractTAOXListing creates a new instance of LAbstractTAOXListing, bound to a specific deployed contract.
func NewLAbstractTAOXListing(address common.Address, backend bind.ContractBackend) (*LAbstractTAOXListing, error) {
	contract, err := bindLAbstractTAOXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractTAOXListing{LAbstractTAOXListingCaller: LAbstractTAOXListingCaller{contract: contract}, LAbstractTAOXListingTransactor: LAbstractTAOXListingTransactor{contract: contract}, LAbstractTAOXListingFilterer: LAbstractTAOXListingFilterer{contract: contract}}, nil
}

// NewLAbstractTAOXListingCaller creates a new read-only instance of LAbstractTAOXListing, bound to a specific deployed contract.
func NewLAbstractTAOXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractTAOXListingCaller, error) {
	contract, err := bindLAbstractTAOXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTAOXListingCaller{contract: contract}, nil
}

// NewLAbstractTAOXListingTransactor creates a new write-only instance of LAbstractTAOXListing, bound to a specific deployed contract.
func NewLAbstractTAOXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractTAOXListingTransactor, error) {
	contract, err := bindLAbstractTAOXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTAOXListingTransactor{contract: contract}, nil
}

// NewLAbstractTAOXListingFilterer creates a new log filterer instance of LAbstractTAOXListing, bound to a specific deployed contract.
func NewLAbstractTAOXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractTAOXListingFilterer, error) {
	contract, err := bindLAbstractTAOXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractTAOXListingFilterer{contract: contract}, nil
}

// bindLAbstractTAOXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractTAOXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTAOXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractTAOXListing *LAbstractTAOXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTAOXListing.Contract.LAbstractTAOXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTAOXListing *LAbstractTAOXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTAOXListing.Contract.LAbstractTAOXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractTAOXListing *LAbstractTAOXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTAOXListing.Contract.LAbstractTAOXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractTAOXListing *LAbstractTAOXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTAOXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTAOXListing *LAbstractTAOXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTAOXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractTAOXListing *LAbstractTAOXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTAOXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractTAOXListing *LAbstractTAOXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractTAOXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractTAOXListing *LAbstractTAOXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractTAOXListing.Contract.GetTokenStatus(&_LAbstractTAOXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractTAOXListing *LAbstractTAOXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractTAOXListing.Contract.GetTokenStatus(&_LAbstractTAOXListing.CallOpts, arg0)
}
...
// TaoXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function TaoXListing() constant returns(address)
func (_Lending *LendingCaller) TaoXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "TaoXListing")
	return *ret0, err
}
...
//
// Solidity: function TaoXListing() constant returns(address)
func (_Lending *LendingSession) TaoXListing() (common.Address, error) {
	return _Lending.Contract.TaoXListing(&_Lending.CallOpts)
}

// TaoXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function TaoXListing() constant returns(address)
func (_Lending *LendingCallerSession) TaoXListing() (common.Address, error) {
	return _Lending.Contract.TaoXListing(&_Lending.CallOpts)
}
