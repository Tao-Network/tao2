...
var (
	TaoMainnetGenesisHash = common.HexToHash("114bf81b4c79870934846bd879ef4db59392eb0152ed9482bdc9a499a12a3538") // Tao Mainnet genesis hash to enforce below configs on
...
func (c *ChainConfig) IsTIPTaoX(num *big.Int) bool {
	if common.IsTestnet {
		return isForked(common.TIPTaoXTestnet, num)
	} else {
		return isForked(common.TIPTaoX, num)
	}
}

func (c *ChainConfig) IsTIPTaoXLending(num *big.Int) bool {
	return isForked(common.TIPTaoXLending, num)
}
